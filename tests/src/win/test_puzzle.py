...
class PuzzleTest(unittest.TestCase):
    ...
    def test_conditions_skip_and_break_on_exceptions_true(self):
        ...
        """
        print("")
        print("test_conditions_skip_and_break_on_exceptions_true")
        tasks = {
            "main": [
                {"module": "tasks.win.rename_namespace",
    ...
    def test_conditions_skip_and_break_on_exceptions_true_and_error_occur(self):
        """
        task run when category is bg.but some error inside script.
        then stop all because break_on_exceptions key is True.
        """
        print("")
        print("test_conditions_skip_and_break_on_exceptions_true_and_error_occur")
        tasks = {
            "main": [
